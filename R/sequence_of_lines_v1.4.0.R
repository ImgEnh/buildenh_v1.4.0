...
if (sek == "bdr_follow") { 
  ...
  if (substr(bnr2,3,3) == "1") { #point numbers >=10 
    part <- "2parts_1"
    bnr2_part <- bnr2
  }

  #if (substr(bnr2,2,2) == "2") { #point numbers <10
  if (substr(bnr2,3,3) == "2") { #point numbers >=10
    part <- "2parts_2"
     bnr2_part <- bnr2
  }
  
  #if (substr(bnr2,2,2) == "3") { #point numbers <10
  if (substr(bnr2,3,3) == "3") { #point numbers >=10
    part <- "3parts_3"
    bnr2_part <- bnr2
  }
